...
DESCRIPTIONS = {
    ...
    "restart_remap_source_p": "Number of source restart cells in the z-direction",
    "restart_remap_source_x_beg": "Beginning of the source restart x-domain",
    "restart_remap_source_x_end": "End of the source restart x-domain",
    "restart_remap_source_y_beg": "Beginning of the source restart y-domain",
    "restart_remap_source_y_end": "End of the source restart y-domain",
    "restart_remap_source_z_beg": "Beginning of the source restart z-domain",
    "restart_remap_source_z_end": "End of the source restart z-domain",
