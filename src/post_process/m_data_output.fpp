...
module m_data_output
    ...
    private; public :: s_initialize_data_output_module, s_switch_output_dirs, s_switch_to_lso_stat_dir, s_define_output_region, &
        ...
        & s_write_intf_data_file, s_write_energy_data_file, s_write_ib_bodies_to_formatted_database_file, &
...
contains
    ...
    impure subroutine s_initialize_data_output_module()
        ...
        if (format == 1) then
            ! Filtered fields (read pre-filtered, or filtered here) go to silo_hdf5_lso/.
